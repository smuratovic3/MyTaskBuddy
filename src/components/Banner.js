          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <span className="tagline">Dobrodošli na MyTaskBuddy!</span>
                  <h1>
                  ...
                  <p>
                    MyTaskBuddy vam olakšava planiranje i organiziranje zadataka
                    za svoju djecu i praćenje njihovog napretka. Uz prilagođene
